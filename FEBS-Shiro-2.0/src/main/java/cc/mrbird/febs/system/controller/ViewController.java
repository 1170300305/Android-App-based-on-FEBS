...
public class ViewController extends BaseController {
     ...
     * @return
     */
    @GetMapping(FebsConstant.VIEW_PREFIX + "system/paper")
    @RequiresPermissions("paper:view")
    public String systemQues() {
        return FebsUtil.view("system/paper/paper");
    }


    @GetMapping(FebsConstant.VIEW_PREFIX + "system/paper/add")
    @RequiresPermissions("paper:add")
    public String systemPaperAdd() {
        return FebsUtil.view("system/paper/paperAdd");
    }
    /**
     * -----------------------------------------------------------------------------------------------------------------
     */
